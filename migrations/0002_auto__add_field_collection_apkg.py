...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'djecks_omeka_collection', 'apkg',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djecks_anki.Deck'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'djecks_omeka.collection': {
            ...
            'apkg': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['djecks_anki.Deck']", 'null': 'True', 'blank': 'True'}),
