...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Collection.apkg'
        db.alter_column(u'djecks_omeka_collection', 'apkg_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djecks_anki.AnkiDeck'], null=True))

    def backwards(self, orm):

        # Changing field 'Collection.apkg'
        db.alter_column(u'djecks_omeka_collection', 'apkg_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djecks_anki.Deck'], null=True))
    ...
    models = {
        ...
        u'djecks_omeka.collection': {
            ...
            'apkg': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['djecks_anki.AnkiDeck']", 'null': 'True', 'blank': 'True'}),
            'deck': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['djecks.Deck']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
